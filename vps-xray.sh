...
echo "============================================================"
echo "             NewDevs SSH Script Installer"
echo "============================================================"
echo ""
...
# SSH SlowDNS
read -p "Enter SlowDNS Nameserver (or press enter for default): " -e -i "ns-dl.NewDevsgh.ovh" Nameserver
...
######################################
###NewDevs AutoScript Code Begins...###
######################################
...
<br><font color="#C12267">NewDevsGH | VPN | SERVICE<br></font><br>
...
<font color="red">• BROUGHT TO YOU BY <br></font><font color="#00cccc">https://t.me/NewDevsfreenet !<br></font>
deekay77
...
# --- Backup & Restore ---
backup_snapshot() {
  clear; local out="/root/NewDevsgh_backup_$(date +%Y%m%d_%H%M%S).tar.gz"
...
restore_snapshot() {
  ...
  echo -e "${CYAN}══════════════════════════════════════════════════════════════${NC}"
  shopt -s nullglob
  backups=(/root/NewDevsgh_backup_*.tar.gz)
...
remove_script() {
  ...
  echo -e "  and scripts installed byNewDevs from your server.\n"
